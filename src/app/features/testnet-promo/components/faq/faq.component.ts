  ...
  public readonly questions = [
    {
      ...
      answer:
        'Ethereum<br/>Arbitrum<br/>BNB Chain<br/>Polygon<br/>Base<br/>Berachain<br/>zkSync Era<br/>Optimism<br/>Avalanche<br/>Scroll<br/>Fraxtal<br/>Soneium<br/>Linea<br/>Mode<br/>Mantle<br/>Metis<br/>Manta Pacific<br/>Fantom<br/>Polygon zkEVM<br/>Pulsechain<br/>Taiko<br/>X Layer<br/>Gnosis<br/>Flare'
    },
    {
