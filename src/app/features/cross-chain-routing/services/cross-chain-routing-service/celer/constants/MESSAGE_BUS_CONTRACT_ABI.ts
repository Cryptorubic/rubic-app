...
export const MESSAGE_BUS_CONTRACT_ABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_pegBridgeV2', type: 'address' },
      { internalType: 'address', name: '_pegVaultV2', type: 'address' }
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'enum MsgDataTypes.MsgType', name: 'msgType', type: 'uint8' },
      { indexed: false, internalType: 'bytes32', name: 'msgId', type: 'bytes32' },
      { indexed: false, internalType: 'enum MsgDataTypes.TxStatus', name: 'status', type: 'uint8' },
      { indexed: true, internalType: 'address', name: 'receiver', type: 'address' },
      { indexed: false, internalType: 'uint64', name: 'srcChainId', type: 'uint64' },
      { indexed: false, internalType: 'bytes32', name: 'srcTxHash', type: 'bytes32' }
    ],
    name: 'Executed',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'feeBase', type: 'uint256' }],
    name: 'FeeBaseUpdated',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'feePerByte', type: 'uint256' }],
    name: 'FeePerByteUpdated',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'liquidityBridge', type: 'address' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'pegBridge', type: 'address' }],
    name: 'PegBridgeUpdated',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'pegBridgeV2', type: 'address' }],
    name: 'PegBridgeV2Updated',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'pegVault', type: 'address' }],
    name: 'PegVaultUpdated',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'pegVaultV2', type: 'address' }],
    ...
    inputs: [
      { internalType: 'bytes', name: '_message', type: 'bytes' },
      {
        components: [
          ...
          { internalType: 'bytes32', name: 'srcTxHash', type: 'bytes32' }
        ],
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: 'enum MsgDataTypes.TransferType', name: 't', type: 'uint8' },
          { internalType: 'address', name: 'sender', type: 'address' },
          { internalType: 'address', name: 'receiver', type: 'address' },
          { internalType: 'address', name: 'token', type: 'address' },
          { internalType: 'uint256', name: 'amount', type: 'uint256' },
          { internalType: 'uint64', name: 'wdseq', type: 'uint64' },
          { internalType: 'uint64', name: 'srcChainId', type: 'uint64' },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'enum MsgDataTypes.TxStatus', name: '', type: 'uint8' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_usage', type: 'uint256' }],
