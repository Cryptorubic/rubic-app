...
export interface Tokens {
  [key: string]: SolanaTokenInfo;
  [index: number]: SolanaTokenInfo;
}
...
export const NATIVE_SOL: SolanaTokenInfo = {
  symbol: 'SOL',
  name: 'Native Solana',
...
export const WRAPPED_SOL: SolanaTokenInfo = {
  symbol: 'WSOL',
  name: 'Wrapped Solana',
