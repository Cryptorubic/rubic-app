...
export class OneInchPolService implements ItProvider {
  ...
  constructor(
    ...
    const network = BlockchainsInfo.getBlockchainByName(BLOCKCHAIN_NAME.POLYGON);
    this.apiBaseUrl = `https://api.1inch.exchange/v3.0/${network.id}/`;
    this.web3Public = this.web3PublicService[BLOCKCHAIN_NAME.POLYGON];
