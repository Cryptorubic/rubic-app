...
import { BridgeTrade } from 'src/app/features/cross-chain-swaps-page-old/bridge-page/models/BridgeTrade';
import { BridgeToken } from 'src/app/features/cross-chain-swaps-page-old/bridge-page/models/BridgeToken';
