...
import { BLOCKCHAINS } from 'src/app/features/cross-chain-swaps-page-old/common/constants/BLOCKCHAINS';
...
import {
  ...
  GetBnbTrade
} from 'src/app/features/cross-chain-swaps-page-old/get-bnb-page/models/GetBnbTrade';
