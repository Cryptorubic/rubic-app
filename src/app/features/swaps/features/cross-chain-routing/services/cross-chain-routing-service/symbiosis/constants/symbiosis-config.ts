import { SymbiosisSupportedBlockchain } from '@features/swaps/features/cross-chain-routing/services/cross-chain-routing-service/symbiosis/constants/contract-address';
import { BLOCKCHAIN_NAME } from '@shared/models/blockchain/blockchain-name';

export type SymbiosisConfigRpcLinks = Record<SymbiosisSupportedBlockchain, string>;

export function getSymbiosisConfig(rpcLink: SymbiosisConfigRpcLinks) {
  return {
    ...
    chains: [
      {
        id: 1,
        rpc: rpcLink[BLOCKCHAIN_NAME.ETHEREUM],
      ...
      {
        id: 56,
        rpc: rpcLink[BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN],
        filterBlockOffset: 100000,
