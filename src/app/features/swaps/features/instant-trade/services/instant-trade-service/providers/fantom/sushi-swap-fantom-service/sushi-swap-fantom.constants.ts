...
const sushiSwapFantomContractAddress = '0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506';
...
export const SUSHI_SWAP_FANTOM_CONSTANTS: UniswapV2Constants = {
  blockchain: BLOCKCHAIN_NAME.FANTOM,
  contractAddress: sushiSwapFantomContractAddress,
  wethAddress,
  routingProviders,
  maxTransitTokens: 2
};
