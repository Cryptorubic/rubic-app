...
export const CENTRALIZATION_CONFIG: Partial<Record<CrossChainTradeType, CentralizationStatus>> = {
  ...
  [CROSS_CHAIN_TRADE_TYPE.CHANGE_HERO]: CENTRALIZATION_STATUS.SEMI_CENTRALIZED,
  [CROSS_CHAIN_TRADE_TYPE.BALTEX]: CENTRALIZATION_STATUS.SEMI_CENTRALIZED,
  [CROSS_CHAIN_TRADE_TYPE.XGRAM]: CENTRALIZATION_STATUS.SEMI_CENTRALIZED,
  [CROSS_CHAIN_TRADE_TYPE.STEALTHEX]: CENTRALIZATION_STATUS.SEMI_CENTRALIZED,
  [CROSS_CHAIN_TRADE_TYPE.THE_CHANGE]: CENTRALIZATION_STATUS.SEMI_CENTRALIZED,
  [CROSS_CHAIN_TRADE_TYPE.CCE_CASH]: CENTRALIZATION_STATUS.SEMI_CENTRALIZED,
  [CROSS_CHAIN_TRADE_TYPE.LIZEX]: CENTRALIZATION_STATUS.SEMI_CENTRALIZED
};
