...
const onChainBlacklist: Record<SupportedOnChainNetworks, OnChainTradeType[]> = {
  ...
  [BLOCKCHAIN_NAME.POLYGON_ZKEVM]: [ON_CHAIN_TRADE_TYPE.XY_DEX],
  ...
  [BLOCKCHAIN_NAME.MOONRIVER]: [ON_CHAIN_TRADE_TYPE.XY_DEX, ON_CHAIN_TRADE_TYPE.DODO],
  ...
  [BLOCKCHAIN_NAME.ETHEREUM_POW]: [ON_CHAIN_TRADE_TYPE.XY_DEX],
  ...
  [BLOCKCHAIN_NAME.ZK_SYNC]: [ON_CHAIN_TRADE_TYPE.XY_DEX],
  [BLOCKCHAIN_NAME.PULSECHAIN]: [],
  [BLOCKCHAIN_NAME.LINEA]: [ON_CHAIN_TRADE_TYPE.XY_DEX, ON_CHAIN_TRADE_TYPE.HORIZONDEX],
  [BLOCKCHAIN_NAME.BASE]: [ON_CHAIN_TRADE_TYPE.XY_DEX],
