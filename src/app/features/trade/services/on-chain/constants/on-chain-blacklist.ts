...
const onChainBlacklist: Record<SupportedOnChainNetworks, OnChainTradeType[]> = {
  [BLOCKCHAIN_NAME.ETHEREUM]: [ON_CHAIN_TRADE_TYPE.ZRX, ON_CHAIN_TRADE_TYPE.CURVE],
  [BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN]: [ON_CHAIN_TRADE_TYPE.CURVE, ON_CHAIN_TRADE_TYPE.ZRX],
  ...
  [BLOCKCHAIN_NAME.OPTIMISM]: [ON_CHAIN_TRADE_TYPE.ZRX, ON_CHAIN_TRADE_TYPE.CURVE],
