...
export const POLYGON_ADDRESSES = {
  [BLOCKCHAIN_NAME.ETHEREUM]: '0xA0c68C638235ee32657e8f720a23ceC1bFc77C77'
};
...
export const POLYGON_BRIDGE_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'bytes32', name: 'tokenType', type: 'bytes32' },
      { indexed: true, internalType: 'address', name: 'predicateAddress', type: 'address' }
    ],
  ...
  {
    inputs: [{ internalType: 'address', name: 'newCheckpointManager', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address', name: 'newStateSender', type: 'address' }],
    name: 'setStateSender',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
