...
import {
  ...
  RetrodropUserInfo
} from '@features/airdrop/models/retrodrop-user-info';
...
export class AirdropStateService {
  private readonly defaultUserClaimInfo: AirdropUserClaimInfo = {
    round: null,
  ...
  private readonly _swapToEarnUserClaimInfo$ = new BehaviorSubject<AirdropUserClaimInfo>(
  ...
  public get airdropUserClaimInfo(): AirdropUserClaimInfo {
  ...
  public set airdropUserClaimInfo(value: AirdropUserClaimInfo) {
  ...
  public async updateSwapToEarnUserPointsInfo(): Promise<void> {
    await this.airdropApiService.fetchAirdropUserPointsInfo().subscribe(points => {
  ...
  private handleAddressChange(): void {
    this.walletConnectorService.addressChange$
      .pipe(
        switchIif(
          Boolean,
          () => this.airdropApiService.fetchAirdropUserPointsInfo(),
