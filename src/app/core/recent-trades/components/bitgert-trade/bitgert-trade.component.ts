...
@Component({
  selector: '[bitgert-trade]',
  templateUrl: './bitgert-trade.component.html',
  styleUrls: ['./bitgert-trade.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class BitgertTradeComponent extends CommonTrade {
  constructor(
