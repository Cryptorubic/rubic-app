...
@Component({
  selector: '[multichain-trade]',
  templateUrl: './multichain-trade.component.html',
  styleUrls: ['./multichain-trade.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MultichainTradeComponent extends CommonTrade {
  constructor(
