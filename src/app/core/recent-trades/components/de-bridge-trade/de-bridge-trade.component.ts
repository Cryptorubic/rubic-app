...
@Component({
  selector: '[de-bridge-trade]',
  templateUrl: './de-bridge-trade.component.html',
  styleUrls: ['./de-bridge-trade.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DeBridgeTradeComponent extends CommonTrade {
  constructor(
