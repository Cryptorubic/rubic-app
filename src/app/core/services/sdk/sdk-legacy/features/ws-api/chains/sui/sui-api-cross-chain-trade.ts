import { PriceTokenAmount, Token, SuiBlockchainName } from '@cryptorubic/core';
...
import { SuiCrossChainTrade } from '../../../cross-chain/calculation-manager/providers/common/sui-cross-chain-trade/sui-cross-chain-trade';
import { SuiApiCrossChainConstructor } from './sui-api-cross-chain-constructor';
import { SdkLegacyService } from '../../../../sdk-legacy.service';
import { RubicApiService } from '../../../../rubic-api/rubic-api.service';

export class SuiApiCrossChainTrade extends SuiCrossChainTrade {
  ...
  constructor(
    params: SuiApiCrossChainConstructor,
