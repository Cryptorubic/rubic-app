import { PriceTokenAmount, RippleBlockchainName, Token } from '@cryptorubic/core';
...
import { RippleCrossChainTrade } from '../../../cross-chain/calculation-manager/providers/common/ripple-cross-chain-trade/ripple-cross-chain-trade';
import { RippleApiCrossChainConstructor } from './ripple-api-cross-chain-constructor';

export class RippleApiCrossChainTrade extends RippleCrossChainTrade {
  ...
  constructor(
    params: RippleApiCrossChainConstructor,
