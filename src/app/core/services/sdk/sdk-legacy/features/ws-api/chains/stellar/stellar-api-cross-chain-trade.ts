import { PriceTokenAmount, StellarBlockchainName, Token } from '@cryptorubic/core';
...
import { StellarCrossChainTrade } from '../../../cross-chain/calculation-manager/providers/common/stellar-cross-chain-trade/stellar-cross-chain-trade';
import { StellarApiCrossChainConstructor } from './stellar-api-cross-chain-constructor';

export class StellarApiCrossChainTrade extends StellarCrossChainTrade {
