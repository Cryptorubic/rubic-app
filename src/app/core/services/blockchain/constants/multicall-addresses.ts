...
export const MULTICALL_ADDRESS: Record<BlockchainName, string> = {
  ...
  [BLOCKCHAIN_NAME.SOLANA]: noValue,
  [BLOCKCHAIN_NAME.NEAR]: noValue,
  [BLOCKCHAIN_NAME.OPTIMISM]: noValue,
  [BLOCKCHAIN_NAME.CRONOS]: noValue,
  [BLOCKCHAIN_NAME.OKE_X_CHAIN]: noValue,
  [BLOCKCHAIN_NAME.GNOSIS]: noValue,
  [BLOCKCHAIN_NAME.FUSE]: noValue,
  [BLOCKCHAIN_NAME.MOONBEAM]: noValue,
  [BLOCKCHAIN_NAME.CELO]: noValue
};
