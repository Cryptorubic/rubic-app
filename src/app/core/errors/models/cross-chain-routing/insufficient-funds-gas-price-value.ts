...
class InsufficientFoundsGasPriceValueError extends RubicWarning<ERROR_TYPE.TEXT> {
  constructor(nativeToken: string) {
    super(InsufficientFundsCcrErrorComponent, {
      nativeToken
    });
    Object.setPrototypeOf(this, InsufficientFoundsGasPriceValueError.prototype);
  }
}

export default InsufficientFoundsGasPriceValueError;
